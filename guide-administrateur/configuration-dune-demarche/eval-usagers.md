# Proposer l'évaluation de la démarche pour les usagers

Proposer aux usagers de donner un avis sur votre démarche, grâce à l’outil mis à disposition par l'[Observatoire de la qualité des démarches en ligne.](https://observatoire.numerique.gouv.fr/) **demarche.numerique.gouv.fr** permet l'intégration directe de l'outil « MonAvis » au sein de votre démarche.
...
{% hint style="warning" %}
Pour utiliser le bouton « mon avis », il faut au préalable **avoir publié votre démarche** sur demarche.numerique.gouv.fr
{% endhint %}

### Connexion au service "Je donne mon avis"
