...
## Réduisez la quantité d’informations demandée
...
## Utilisez des blocs répétables et les champs conditionnels
...
## Utilisez l'option « champ obligatoire » avec précaution
...
## Faites un test complet avant publication
...
## Personnalisez l’URL de votre démarche et informez votre délégué à la protections des données :  &#x20;
